  ...
  return (
    <section id="services" className="py-16 bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl dark:text-white font-extrabold text-text-muted mb-8 text-center ">
          Our Services
        </h2>
        ...
        {index == 3 && (
          <div className="my-8 w-full flex justify-center">
            <Link href="/services">
              <button className="bg-[#442817] dark:bg-white dark:text-text-muted text-white px-8 py-3 rounded hover:bg-[#5d371f] transition-colors">
                More Services
              </button>
            </Link>
          </div>
